...
def main():
    left_hand = AgibotHandO10.create_hand(canfd_id=0, hand_type=EHandType.LEFT, channel_id=0)
    right_hand = AgibotHandO10.create_hand(canfd_id=0, hand_type=EHandType.RIGHT, channel_id=1)

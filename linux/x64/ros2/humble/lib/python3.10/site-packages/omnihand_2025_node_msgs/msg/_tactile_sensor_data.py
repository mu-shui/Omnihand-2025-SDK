...
class TactileSensorData(metaclass=Metaclass_TactileSensorData):
    ...
    def __init__(self, **kwargs):
        ...
        self.tactiles = array.array('B', kwargs.get('tactiles', []))
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.tactiles != other.tactiles:
            return False
        return True
    ...
    @builtins.property
    def tactiles(self):
        """Message field 'tactiles'."""
        return self._tactiles

    @tactiles.setter
    def tactiles(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'tactiles' array.array() must have the type code of 'B'"
            self._tactiles = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'tactiles' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._tactiles = array.array('B', value)

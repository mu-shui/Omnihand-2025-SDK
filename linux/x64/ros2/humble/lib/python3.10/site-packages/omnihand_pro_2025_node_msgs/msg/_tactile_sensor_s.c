...
bool omnihand_pro_2025_node_msgs__msg__tactile_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // tactile_datas
    ...
    if (!omnihand_pro_2025_node_msgs__msg__TactileSensorData__Sequence__init(&(ros_message->tactile_datas), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create omnihand_pro_2025_node_msgs__msg__TactileSensorData__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    omnihand_pro_2025_node_msgs__msg__TactileSensorData * dest = ros_message->tactile_datas.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!omnihand_pro_2025_node_msgs__msg__tactile_sensor_data__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * omnihand_pro_2025_node_msgs__msg__tactile_sensor__convert_to_py(void * raw_ros_message)
{
  ...
  {  // tactile_datas
    ...
    omnihand_pro_2025_node_msgs__msg__TactileSensorData * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->tactile_datas.data[i]);
      PyObject * pyitem = omnihand_pro_2025_node_msgs__msg__tactile_sensor_data__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }

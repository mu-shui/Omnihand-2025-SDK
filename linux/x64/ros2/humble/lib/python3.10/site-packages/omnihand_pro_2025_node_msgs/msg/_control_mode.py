...
class ControlMode(metaclass=Metaclass_ControlMode):
    ...
    def __init__(self, **kwargs):
        ...
        self.modes = array.array('b', kwargs.get('modes', []))
    ...
    def modes(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'b', \
                "The 'modes' array.array() must have the type code of 'b'"
            self._modes = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'modes' field must be a set or sequence and each value of type 'int' and each integer in [-128, 127]"
        self._modes = array.array('b', value)

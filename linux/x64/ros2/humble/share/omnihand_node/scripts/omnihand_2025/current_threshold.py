...
@Date: 2025-11-06
@Description: Python node for current threshold (Omnihand2025)
"""
        初始化电流阈值节点
        ...
        self.current_threshold_fb_publisher = self.create_publisher(
            CurrentThreshold,
            f'/omnihand/omnihand_2025/{hand_side}/current_threshold_cmd',
            10
        )
        ...
        self.current_threshold_subscriber = self.create_subscription(
            CurrentThreshold,
            f'/omnihand/omnihand_2025/{hand_side}/current_threshold',
        ...
        self.get_logger().info(f'Publishing to: /omnihand/omnihand_2025/{hand_side}/current_threshold')
        self.get_logger().info(f'Subscribing to: /omnihand/omnihand_2025/{hand_side}/current_threshold')

...
@Date: 2025-01-XX
@Description: Demo script for setting and getting joint angles using SetJointAngles and GetJointAngles services (OmniHand 2025)
"""
...
class SetGetJointAnglesDemo(Node):
    ...
    def __init__(self, hand_side='left'):
        ...
        """
        super().__init__('set_get_joint_angles_demo')
        ...
        self.get_logger().info(f'{hand_side.capitalize()} Hand Set/Get JointAngles Demo started')
...
def main(args=None):
    ...
    try:
        ...
        target_angles_2 = [math.radians(1.0)] * 10  # 1度转换为弧度

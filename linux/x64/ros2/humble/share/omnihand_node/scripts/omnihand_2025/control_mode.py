...
@Date: 2025-11-06
@Description: Python node for control mode (Omnihand2025)
"""
...
try:
    from omnihand_2025_node_msgs.msg import ControlMode, CurrentReport
except ImportError:
...
class ControlModeNode(Node):
    def __init__(self, hand_side='left'):
        ...
        self.control_mode_fb_publisher = self.create_publisher(
            ControlMode,
            f'/omnihand/omnihand_2025/{hand_side}/control_mode_fb',
            10
        )
        ...
        self.control_mode_subscriber = self.create_subscription(
            ControlMode,
            f'/omnihand/omnihand_2025/{hand_side}/control_mode',

...
@Date: 2025-11-06
@Description: Python node for motor angle (Omnihand2025)
"""
        初始化电机角度节点
        ...
        self.motor_angle_fb_publisher = self.create_publisher(
            MotorAngle,
            f'/omnihand/omnihand_2025/{hand_side}/motor_angle_cmd',
            10
        )
        ...
        self.motor_angle_subscriber = self.create_subscription(
            MotorAngle,
            f'/omnihand/omnihand_2025/{hand_side}/motor_angle',
        ...
        self.get_logger().info(f'Publishing to: /omnihand/omnihand_2025/{hand_side}/motor_angle_cmd')
        self.get_logger().info(f'Subscribing to: /omnihand/omnihand_2025/{hand_side}/motor_angle')

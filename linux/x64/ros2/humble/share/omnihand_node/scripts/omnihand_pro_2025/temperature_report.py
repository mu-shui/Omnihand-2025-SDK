...
@Date: 2025-11-06
@Description: Python node for temperature report (Omnihand2025Pro)
"""
        初始化温度报告订阅节点
        ...
        self.temperature_report_fb_subscriber = self.create_subscription(
            TemperatureReport,
            f'/omnihand/omnihand_pro_2025/{hand_side}/temperature_report',
        ...
        self.get_logger().info(f'Subscribing to: /omnihand/omnihand_pro_2025/{hand_side}/temperature_report')

...
"""
Unit tests for OmniHand 3 Lite S (O4) with ZLG CAN device
"""
...
@pytest.fixture
def hand():
    """Create and initialize OmniHand 3 Lite S (O4) instance for testing with ZLG CAN"""
    ...
    print(f"[Info]: Using device type: zlgcan")
    yield hand

...
"""
OmniHand 2025 综合控制示例 - SocketCAN 通信（仅 Linux）
...
def main():
    ...
    print("=" * 60)
    print("OmniHand 2025 - SocketCAN Control")
    print(f"Mode: {mode}")
    print("=" * 60)
    ...
    if mode == "left" or mode == "both":
        left_hand = OmniHand2025.create_hand_socketcan(
    ...
    if mode == "right" or mode == "both":
        ...
        right_hand = OmniHand2025.create_hand_socketcan(
